...
from m2vg.utils import load_checkpoint
...
from m2vg.datasets.pipelines.transforms import Normalize, Resize
from m2vg.datasets.pipelines.formatting import DefaultFormatBundle, CollectData
import matplotlib as mpl
from m2vg.utils.visualizer import GenericMask, VisImage
...
def parse_args():
    ...
    parser.add_argument(
        "--img",
        default="asserts/imgs/Figure_2.jpg",
        help="Image file",
    )
    parser.add_argument("--expression", default="full half fruit", help="text")
    parser.add_argument(
        "--config",
        default="configs/refcoco/M2VG-B-refcoco/M2VG-B-refcoco.py",
        help="Config file",
    )
    parser.add_argument(
        "--img_size",
    ...
    parser.add_argument(
        "--checkpoint",
        default="work_dir/refcoco/M2VG-B-refcoco/M2VG-B-refcoco.pth",
